    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card p-2">
          ...
          <h3 class="card-header"><i class="fa fa-database"></i> KATEGORI DOKUMEN SK</h3>
          <ul class="card-body list-unstyled">
            <?php
            foreach ($kategori_sk as $ks) {
            ?>
            <li class="p-2">
              <i class="fa fa-file"></i><a class="link" href="<?php echo base_url(); ?>file/sk_tampil/<?php echo $this->session->userdata("kategori"); ?>/<?php echo $ks->nama_kategori; ?>"> DOKUMEN <?php echo strtoupper($ks->nama_kategori); ?></a>
            </li>
            <?php
            }
            ?>
