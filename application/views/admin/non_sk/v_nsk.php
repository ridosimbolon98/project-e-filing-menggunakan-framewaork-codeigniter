  ...
  <div class="container pt-4">
    <div class="row align-middle">
      ...
      <div class="col-sm-9 input-group mb-3">
        <form class="input-group" method="get" action="<?php echo base_url(); ?>file/nsk_tampil/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>">
      ...
      <form class="input-group" method="get" action="<?php echo base_url(); ?>file/filter_nsk/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>">
        <div class="col-sm-6">
          ...
          <table class="table table-hover">
            <thead class="bg-dark text-light">
              <tr  class="text-center">
                <th>No</th>
                <th>Judul Non-SK <a href="<?php echo base_url(); ?>file/nsk_urut_judul/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th>Nama File <a href="<?php echo base_url(); ?>file/nsk_urut_nama_file/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th>Tahun <a href="<?php echo base_url(); ?>file/nsk_urut_tahun/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="<?php echo base_url(); ?>file/nsk_hasil/<?php echo $kat_admin; ?>/<?php echo $s->id; ?>/<?php echo $s->kategori; ?>" target="_blank"><i class="fa fa-eye text-primary"></i></a>
                </td>
                <td class="text-center">
                  <?php echo anchor('../file/nsk_hapus/'.$kat_admin.'/'.$s->id.'/'.$s->kategori,'<i class="fa fa-trash text-danger"></i>'); ?>
                </td>
                <td class="text-center">
                  <?php echo anchor('../file/nsk_download/'.$kat_admin.'/'.$s->id.'/'.$s->kategori,'<i class="fa fa-download text-secondary"></i>'); ?>
                </td>
              </tr>
              <?php 
                  $no++;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title">Tambah File Non-SK <?php echo $kategori; ?></h5>
          ...
          <form method="post" action="<?php echo base_url(); ?>file/upload_nsk_file/<?php echo $kategori; ?>" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <div class="file-field">
                  <input id="input_file" class="btn btn-primary btn-sm float-left" type="file" name="nsk">
              </div>
            </div>
