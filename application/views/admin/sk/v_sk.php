  ...
  <div id="side_bar" class="sidebar bar-block bg-side">
    ...
    <div class="bg-g text-dark">
      ...
      <div class="collapse pl-3" id="collapseSK">
        ...
        ?>
          <a class="dropdown-item" href="<?php echo base_url(); ?>file/sk_tampil/<?php echo $this->session->userdata("kategori"); ?>/<?php echo $ks->nama_kategori; ?>"><i class="fa fa-file"></i> <?php echo $ks->nama_kategori; ?></a>
        <?php
         }
        ?>
      </div>
    ...
    <div>
      ...
      <div class="collapse pl-3" id="collapseNSK">
        <?php
          foreach ($kategori_sk as $ks) {
        ?>
          <a class="dropdown-item" href="<?php echo base_url(); ?>file/nsk_tampil/<?php echo $this->session->userdata("kategori"); ?>/<?php echo $ks->nama_kategori; ?>"><i class="fa fa-file"></i> Dokumen <?php echo $ks->nama_kategori; ?></a>
        <?php
         }
        ?>
      </div>
  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <div class="col-sm-9 input-group mb-3">
        <form class="input-group" method="get" action="<?php echo base_url(); ?>file/sk_tampil/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>">
          ...
          <button class="btn btn-warning" type="submit" name="submit"><i class="fa fa-file-text-o float-left"></i> Tampilkan</button>
        </form>
      </div>

      <form class="input-group" method="get" action="<?php echo base_url(); ?>file/filter/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>">
        <div class="col-sm-6">
          ...
          <table class="table table-hover">
            <thead class="bg-dark text-light">
              <tr  class="text-center">
                <th>No</th>
                <th>No SK <a href="<?php echo base_url(); ?>file/sk_urut_nosk/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th>Judul SK <a href="<?php echo base_url(); ?>file/sk_urut_judul/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th>Nama File <a href="<?php echo base_url(); ?>file/sk_urut_nama_file/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th>Tahun <a href="<?php echo base_url(); ?>file/sk_urut_tahun/<?php echo $kat_admin; ?>/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="<?php echo base_url(); ?>file/hasil/<?php echo $kat_admin; ?>/<?php echo $s->id; ?>/<?php echo $s->kategori; ?>" target="_blank"><i class="fa fa-eye text-primary"></i></a>
                </td>
                <td class="text-center">
                  <?php echo anchor('../file/sk_hapus/'.$kat_admin.'/'.$s->id.'/'.$s->kategori,'<i class="fa fa-trash text-danger"></i>'); ?>
                </td>
                <td class="text-center">
                  
                  <?php echo anchor('../file/sk_download/'.$kat_admin.'/'.$s->id.'/'.$s->kategori,'<i class="fa fa-download text-secondary"></i>'); ?>
                </td>
              </tr>
              <?php 
                  $no++;
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        <div class="modal-header bg-primary text-white">
          <h5 class="modal-title">Tambah File SK <?php echo $s->kategori; ?></h5>
        ...
        <div class="modal-body">
          ...
          $kat = array(); 
          $x   = 0;
          foreach ($kategori_sk as $kat_sk) {
            $kat[$x] = $kat_sk->nama_kategori;
            $x++;
          }
          ?>
          <form method="post" action="<?php echo base_url(); ?>file/upload_sk_file/<?php echo $kategori; ?>" enctype="multipart/form-data">
