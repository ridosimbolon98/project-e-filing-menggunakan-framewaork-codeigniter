...
<div id="halaman">
  ...
  <div class="container pt-4">
    <div class="row">
      <div class="col-sm-3 mb-3">
        <a href="#" class="btn btn-primary form-control" data-toggle="modal" data-target="#tambahNSKModal">
          <i class="fa fa-upload float-left"></i> Unggah File
        </a>
      </div>

      <div class="col-sm-9 input-group mb-3">
        <form class="input-group" method="get" action="<?php echo base_url(); ?>file/fkl_nsk_tampil/<?php echo $kategori; ?>">
      ...
      <form class="input-group" method="get" action="<?php echo base_url(); ?>file/fkl_cari_f_nsk/<?php echo $kategori; ?>">
        <div class="col-sm-6">
          ...
          <table class="table table-hover">
            <thead class="bg-dark text-light">
              <tr  class="text-center">
                <th>No</th>
                <th>Judul Non-SK <a href="<?php echo base_url(); ?>file/fkl_nsk_urut_judul/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th>Nama File  <a href="<?php echo base_url(); ?>file/fkl_nsk_urut_nama_file/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th>Unit <a href="<?php echo base_url(); ?>file/fkl_nsk_urut_unit/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
                <th style="column-width: 80px;">Tahun <a href="<?php echo base_url(); ?>file/fkl_nsk_urut_tahun/<?php echo $kategori; ?>" class="float-right text-white"><i class="fa fa-sort"></i> </a></th>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="text-center">
                  <a href="<?php echo base_url(); ?>file/fkl_nsk_hasil/<?php echo $s->id; ?>/<?php echo $s->kategori; ?>" target="_blank"><i class="fa fa-eye text-primary"></i></a>
                </td>
                <td class="text-center">
                  <?php echo anchor('../file/fkl_nsk_hapus/'.$s->id_dep.'/'.$s->id.'/'.$s->kategori,'<i class="fa fa-trash text-danger"></i>'); ?>
                </td>
                <td class="text-center">
                  <?php echo anchor('../file/fkl_nsk_download/'.$s->id_dep.'/'.$s->id.'/'.$s->kategori,'<i class="fa fa-download text-secondary"></i>'); ?>
                </td>
              </tr>
              <?php 
                  $no++;
  ...
  <div class="modal fade" id="tambahNSKModal">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          $kat = array(); 
          $x   = 0;
          foreach ($kategori_f_nsk as $kat_sk) {
            $kat[$x] = $kat_sk->nama_kategori;
            $x++;
          }
          ?>
          <form method="post" action="<?php echo base_url(); ?>file/upload_f_nsk_file/<?php echo $kategori; ?>" enctype="multipart/form-data">
...
<script>
    $(function () {
        $(document).on('click', '.edit-record', function (e) {
            e.preventDefault();
            $("#myModal").modal('show');
            $.post("<?php echo base_url(); ?>file/fkl_nsk_hasil/<?php echo $kategori; ?>",
