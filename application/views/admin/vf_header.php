...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>assets/css/style_fakultas.css">
...
<body>
  <!-- NAVBAR -->
  <nav class="navbar navbar-expand-sm navbar-dark bg-dark pl-5 pr-5 fixed-top">
    <a href="<?php echo base_url(); ?>admin/up2ti" class="navbar-brand">ADMIN E-FILING</a>
