...
<div id="halaman">
  ...
  <div class="container pt-4">
    <div class="row">
      ...
      <div class="col-sm-3 mb-2">
        <a class="btn btn-success form-control" href="<?php echo base_url(); ?>admin/kategori_file"><i class="fa fa-refresh"></i> Tampilkan Semua</a>
      </div>

      <div class="col-sm-6 mb-2">
        <form method="get" action="<?php echo base_url(); ?>admin/cari_kategori">
          ...
          <table class="table table-hover">
            ...
            <tbody>
              ...
              <tr class="text-center">
                ...
                <td>
                  <?php echo anchor('../admin/hapus_kategori_file/'.$s->id,'<i class="fa fa-trash text-danger"></i>'); ?>
                </td>
              </tr>
              <?php 
                  $no++;
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="<?php echo base_url(); ?>admin/ubah_kategori_file/<?php  ?>">
