  <div id="side_bar" class="sidebar bar-block bg-side">
    ...
    <div class="bg-g text-dark">
      <a href="<?php echo base_url(); ?>admin/f_sk" class="dropdown-item" data-toggle="collapse" data-target="#collapseSK" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-folder-open-o"></i> Dokumen SK 
      <i class="fa fa-arrow-circle-down float-right"></i></a>
    ...
    <div>
      <a href="<?php echo base_url(); ?>admin/f_non_sk" class="dropdown-item" data-toggle="collapse" data-target="#collapseNSK" aria-expanded="false" aria-controls="collapseExample"><i class="fa fa-folder"></i> Dokumen Non-SK 
      <i class="fa fa-arrow-circle-down float-right"></i></a>
  ...
  <div class="container pt-4">
    <div class="row">
      <div class="col-sm-3 mb-2">
        <a class="btn btn-danger form-control" href="<?php echo base_url(); ?>admin/f_sk"><i class="fa fa-arrow-circle-left"></i> Kembali</a>
      </div>

      <div class="col-sm-3 mb-2">
        <a class="btn btn-success form-control" href="<?php echo base_url(); ?>file/f_sk_tampil/<?php echo $kategori; ?>"><i class="fa fa-refresh"></i> Tampilkan Semua</a>
      </div>

      <div class="col-sm-6 mb-2">
        <form method="get" action="<?php echo base_url(); ?>file/cari_f_sk/<?php echo $kategori; ?>">
