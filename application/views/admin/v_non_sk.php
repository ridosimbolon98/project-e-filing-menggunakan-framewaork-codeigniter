      ...
      <div class="col-sm-12">
        <div class="card p-2">
          ...
          <ul class="card-body list-unstyled">
            ...
            ?>
            <li class="p-2">
              <i class="fa fa-file"></i><a class="link" href="<?php echo base_url(); ?>file/nsk_tampil/<?php echo $this->session->userdata("kategori"); ?>/<?php echo $ks->nama_kategori; ?>"> DOKUMEN NON-SK <?php echo strtoupper($ks->nama_kategori); ?></a>
            </li>
            <?php
            }
            ?>
